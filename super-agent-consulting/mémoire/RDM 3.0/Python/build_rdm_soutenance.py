    ...
    <style>
        ...
        * { box-sizing: border-box; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
        ...
        @media print {
            ...
            /* Navigation elements remain visible in PDF for print-interactivity */
...
for titre, section_ref in chapitres:
    ...
    sommaire_html += f"""
        ...
        <span id="src-sommaire-{section_ref}" style="display: inline-block; width: 1px; height: 1px;"></span>
...
pages.append({
    ...
    "content": """
        ...
        <div class="glass-card" style="border-left: 4px solid var(--gold); padding: 25px; margin-top: 30px;">
            ...
            <strong>Réseau B2B Premium :</strong> Happy House gère 146 hébergeurs (60% Pros / 40% Particuliers) avec une équipe Lean (4 ETP).<br>
...
pages.append({
    ...
    "content": """
        ...
        <h1>Remerciements & Cadre Analytique <a href="#src-sommaire-PRÉAMBULE MÉTHODOLOGIQUE" class="btn-sommaire">↩ RETOUR SOMMAIRE (p. 2)</a></h1>
        ...
        <div class="expert-note" style="margin-top: 10px; font-size: 9.5pt; padding: 10px 15px; border-left: 4px solid var(--gold); background: rgba(221, 168, 62, 0.05);">
            ...
            <strong>3. Anonymisation de l'hébergeur audité (Domaine de la Preuve) :</strong> Pour des raisons de stricte confidentialité commerciale et de protection des données, l'identité réelle du domaine Premium de référence (utilisé pour modéliser le ROI de la centrale d'achats Entegra et prouver la viabilité de l'adhésion) a été anonymisée. Cet établissement sera désigné sous l'appellation générique de <strong>"Domaine de la Preuve"</strong> tout au long de ce document.
...
pages.append({
    ...
    "content": """
        ...
        <h1>Lexique et Acronymes <a href="#src-sommaire-LEXIQUE & ACRONYMES" class="btn-sommaire">↩ RETOUR SOMMAIRE (p. 2)</a></h1>
...
pages.append({
    ...
    "content": """
        ...
        <h1>Chapitre 1 — L'Entreprise & La Problématique <a href="#src-sommaire-CHAPITRE 1 : L'ENTREPRISE" class="btn-sommaire">↩ RETOUR SOMMAIRE (p. 2)</a></h1>
...
pages.append({
    ...
    "content": """
        ...
        <div class="visual-block" style="border-color: #DDA83E;">
            ...
            <div class="code-line">Malgré cette structure légère (4 ETP), le réseau revendique la gestion d'un parc ayant atteint <strong>146 adhérents qualifiés</strong> à travers la France.</div>
...
pages.append({
    ...
    "content": """
        ...
        <div class="analytic-content">La base installée historique revendique <span class="analytic-highlight">146 adhérents</span>, gérés par seulement 4 collaborateurs (dont 75% d'alternants). Ce ratio de plus de 40 clients Premium par employé est intenable sans automatisation sévère.</div>
...
pages.append({
    ...
    "content": """
        ...
        <h1>Chapitre 2 — Le Diagnostic Externe : La Fatigue Numérique <a href="#src-sommaire-CHAPITRE 2 : LE MARCHÉ" class="btn-sommaire">↩ RETOUR SOMMAIRE (p. 2)</a></h1>
        ...
        <p>Afin de structurer la nouvelle acquisition (répondre à la problématique), il est impératif de disséquer la psychologie de la cible. L’analyse macro-économique démontre que l'hébergeur indépendant évolue dans un environnement d'une complexité institutionnelle et technologique croissante. <span id="src-annexe-pestel" style="display: inline-block; width: 1px; height: 1px;"></span><a href="#annexe-1" class="btn-annexe">VOIR MATRICE PESTEL (ANNEXE 1) ➔</a> <span id="src-annexe-porter" style="display: inline-block; width: 1px; height: 1px;"></span><a href="#annexe-3" class="btn-annexe">VOIR FORCES DE PORTER (ANNEXE 3) ➔</a></p>
...
pages.append({
    ...
    "content": """
        ...
        <h1>Chapitre 3 — Audit Interne : La Vulnérabilité du Modèle <a href="#src-sommaire-CHAPITRE 3 : AUDIT INTERNE" class="btn-sommaire">↩ RETOUR SOMMAIRE (p. 2)</a></h1>
        ...
        <p>Le diagnostic de marché valide la nécessité absolue de nos services (faire baisser les factures via Entegra est le seul moyen de survie face aux OTAs). <span id="src-annexe-swot" style="display: inline-block; width: 1px; height: 1px;"></span><a href="#annexe-2" class="btn-annexe">VOIR MATRICE SWOT (ANNEXE 2) ➔</a>. Pourtant, l'audit interne (réalisé avec la Direction Data, R. Marie-Luce) révèle une attrition commerciale critique.</p>
...
pages.append({
    ...
    "content": """
        ...
        <h1>Chapitre 4 — L'Audit Data : Le Filtre Légal (ALUR) <a href="#src-sommaire-CHAPITRE 4 : AUDIT DATA & LOI ALUR" class="btn-sommaire">↩ RETOUR SOMMAIRE (p. 2)</a></h1>
...
pages.append({
    ...
    "content": """
        ...
        <div class="analytic-content">Le fichier de 126k contacts devient un outil de <em>Ciblage Prioritaire</em>. Une fois la sélection IA terminée, les processus d'automatisation (POC) modélisent la mise en relation avec les Offices du Tourisme locaux, couplée à l'envoi d'une série d'emails de chauffe ("Nurturing") pour préparer le terrain avant l'appel d'invitation du SDR. L'approche commerciale consiste à proposer à ces particuliers la <strong>professionnalisation</strong> de leur lieu comme unique solution de survie. <span id="src-annexe-crm" style="display: inline-block; width: 1px; height: 1px;"></span><a href="#annexe-8" class="btn-annexe">VOIR PREUVES CRM ET NURTURING (ANNEXE 8) ➔</a></div>
...
pages.append({
    ...
    "content": """
        ...
        <h1>Chapitre 5 — Audit d'Acquisition : L'Impasse Outbound <a href="#src-sommaire-CHAPITRE 5 : AUDIT ACQUISITION" class="btn-sommaire">↩ RETOUR SOMMAIRE (p. 2)</a></h1>
        ...
        <div class="analytic-content">La direction d'une entreprise a souvent un biais cognitif favorisant la méthode "historique". L'intuition ou le simple "ressenti" d'inefficacité ne suffisent pas pour imposer un changement de cap (le Pivot). Il faut "tuer" l'ancienne méthode de manière irréfutable en chiffrant son Coût d'Acquisition Client (CAC) et son Ratio LTV/CAC. <span id="src-annexe-cac" style="display: inline-block; width: 1px; height: 1px;"></span><a href="#annexe-4" class="btn-annexe">VOIR CALCULS CAC (ANNEXE 4) ➔</a></div>
...
pages.append({
    ...
    "content": """
        ...
        <h1>Chapitre 6 — Le Pivot Stratégique : Les Personas & Le Pricing <a href="#src-sommaire-CHAPITRE 6 : L'ANATOMIE DU PIVOT" class="btn-sommaire">↩ RETOUR SOMMAIRE (p. 2)</a></h1>
        ...
        <div class="analytic-content">
            ...
            <strong>Le Remède Happy House :</strong> L'approche Cost-Killing. L'invitation à l'Afterwork ne parlera jamais de "réseau" ou de "convivialité", mais exclusivement d'une méthode chiffrée pour réduire ses frais F&B de 20% via Entegra. <span id="src-annexe-disc" style="display: inline-block; width: 1px; height: 1px;"></span><a href="#annexe-6" class="btn-annexe">VOIR SCRIPT DISC (ANNEXE 6) ➔</a>
...
pages.append({
    ...
    "content": """
        ...
        <h1>Chapitre 7 — La Rétention : Le Dashboard R.O.I <a href="#src-sommaire-CHAPITRE 7 : LA RÉTENTION" class="btn-sommaire">↩ RETOUR SOMMAIRE (p. 2)</a></h1>
...
pages.append({
    ...
    "content": """
        ...
        <div class="analytic-point">5. L'Impératif UI/UX (Expérience Utilisateur)</div>
        ...
        <div class="analytic-content">La conception de l'outil numérique n'est rien sans un soin obsessionnel apporté à l'interface (UI) et à l'expérience utilisateur (UX). On peut concevoir la meilleure formule de partenariat commercial, l'outil de gestion ou PMS le plus performant du marché, ou même le gîte le plus beau et le mieux équipé : sans une interface fluide, intuitive et soignée, l'adoption par l'hébergeur ou le voyageur n'aura pas lieu et l'outil perdra toute efficacité pratique.</div>
        ...
        <div class="analytic-point">6. La Maladie du Client (L'Oubli)</div>
...
pages.append({
    ...
    "content": """
        ...
        <h1>Chapitre 8 — Plan d'Action, Guide Logistique & COPIL <a href="#src-sommaire-CHAPITRE 8 : LE PLAN D'ACTION" class="btn-sommaire">↩ RETOUR SOMMAIRE (p. 2)</a></h1>
        ...
        <h2>1. Objectiver la promesse comptable (Le Cas du Domaine de la Preuve)</h2>
        ...
        <div class="analytic-content">L'analyse d'audit du domaine Premium "Domaine de la Preuve" révèle une équation comptable magistrale : Un investissement initial de <span class="analytic-highlight">360 €</span> (La cotisation réseau) a généré <span class="analytic-highlight">4 120 € de bénéfice net d'exploitation</span> factuel et documenté, couplé à une génération exceptionnelle de <span class="analytic-highlight">11 000 € de CA additionnel</span> issu de l'apport d'affaires inter-réseau. <span id="src-annexe-preuve" style="display: inline-block; width: 1px; height: 1px;"></span><a href="#annexe-10" class="btn-annexe">VOIR BILAN COMPTABLE (ANNEXE 10) ➔</a> <a href="#annexe-11" class="btn-annexe">VOIR EXTRAITS COMPTABLES (ANNEXE 11) ➔</a></div>
...
pages.append({
    ...
    "content": """
        ...
        <h1>Chapitre 9 — Bilan Personnel & CV Digital <a href="#src-sommaire-CHAPITRE 9 : BILAN & PROFIL" class="btn-sommaire">↩ RETOUR SOMMAIRE (p. 2)</a></h1>
        ...
        <p style="margin-bottom: 10px; font-size: 10pt; line-height: 1.5;">Ce parcours d'intégration et de consulting au sein de la gouvernance de Happy House m'a confronté à la réalité sociologique et réglementaire d'un marché saturé par la fatigue numérique. La data et la technologie ne sont rien sans l'humain : plus l'approche est tech-centrée, plus la réassurance par le contact humain et l'onboarding est une priorité absolue.</p>
        ...
        <p style="margin-bottom: 10px; font-size: 10pt; line-height: 1.5;">L'enseignement fondamental de cette alternance réside dans l'importance cruciale de l'interface (UI) et de l'expérience utilisateur (UX) comme préoccupation prioritaire. On peut concevoir la meilleure formule de partenariat commercial, l'outil numérique le plus puissant du marché, ou même le gîte le plus beau et le mieux équipé : sans un parcours utilisateur fluide et une interface intuitive et soignée, l'adoption par l'hébergeur ou le voyageur s'effondre et l'outil perd son efficacité pratique.</p>
        ...
        <p style="margin-bottom: 10px; font-size: 10pt; line-height: 1.5;">Le refus de la direction de déployer l'automatisation de masse m'a forcé à développer un modèle hybride Inbound organique, témoignant d'une compétence suprême : la résilience, la maturité politique en entreprise, et la capacité à piloter des équipes pluridisciplinaires (méthodologie DISC avec Younes).</p>
        ...
        <h2 style="margin-top: 15px; margin-bottom: 5px; color: var(--gold-light);">Bilan des Compétences Acquises</h2>
        ...
        <table style='width: 100%; border-collapse: collapse; font-size: 8.5pt; margin-top: 5px;'>
            ...
            <tr style='background: rgba(221, 168, 62, 0.2);'><th style='width: 50%; padding: 8px 12px; text-align: center;'>HARD SKILLS (Savoir-Faire Technique)</th><th style='width: 50%; padding: 15px; text-align: center;'>SOFT SKILLS (Savoir-Être Managérial)</th></tr>
            ...
            <tr>
                ...
                <td style='padding: 8px 12px; line-height: 1.4;'>
                    ...
                    • <strong>UI & UX Design :</strong> Compréhension critique de l'interface et du parcours utilisateur comme préoccupation prioritaire de l'adoption logicielle.<br><br>
    ...
    "content": """
        ...
        <div class="glass-card" style="border: 1px solid var(--gold); padding: 30px;">
            ...
            <div style="display: flex; gap: 15px; justify-content: center; margin-top: 25px; flex-wrap: wrap;">
                ...
                <a href="https://www.linkedin.com/in/julien-florence-2536a083" target="_blank" class="btn-nav" style="display: inline-block; border: 1px solid var(--gold); color: var(--gold); font-weight: bold; width: 100%; max-width: 260px; padding: 10px 15px; font-size: 9.5pt; text-align: center; text-transform: uppercase; letter-spacing: 1px; transition: all 0.2s; text-decoration: none; border-radius: 3px;">
                ...
                <a href="https://julienflorenceflorence-oss.github.io/cv-prestige/" target="_blank" class="btn-nav" style="display: inline-block; background: var(--gold); color: #000; font-weight: bold; width: 100%; max-width: 260px; padding: 10px 15px; font-size: 9.5pt; text-align: center; text-transform: uppercase; letter-spacing: 1px; transition: all 0.2s; text-decoration: none; border-radius: 3px;">
...
pages.append({
    ...
    "content": """
        <a id="chapitre-10"></a>
        <h1>Chapitre 10 — Déclaration de Conformité IA <a href="#src-sommaire-CHAPITRE 10 : CONFORMITÉ IA" class="btn-sommaire">↩ RETOUR SOMMAIRE (p. 2)</a></h1>
        ...
        <div class="glass-card" style="border-left: 4px solid var(--gold); margin-top: 25px; padding: 20px;">
            <ul style="margin:0; padding-left: 15px; font-size: 10pt; line-height: 1.6;">
                ...
                <li style="margin-top: 8px;"><strong>Périmètre d'intervention de l'algorithme :</strong> Aide à la relecture syntaxique (pour élever et préserver le ton clinique "Consulting Expert" des standards académiques), et génération intégrale du code informatique (HTML/CSS embarqué via script Python) nécessaire à la mise en page logicielle avancée du document PDF final.</li>
                <li style="margin-top: 8px;"><strong>Responsabilité exclusive de l'auteur (Déclaration sur l'honneur) :</strong> L'intégralité du diagnostic analytique en 6 étapes, les choix d'évaluation de la matrice d'analyse (PESTEL, SWOT, Porter), la compréhension et l'explication des blocages stratégiques (Loi ALUR, le veto de la marque et le pivot Inbound), la conception du plan d'action et du budget (le Dashboard, le SOP Afterwork), ainsi que <strong>100% des données chiffrées relatives à l'activité</strong> (ARPU fixé à 226€, Ratio critique LTV/CAC à 0.16, métriques comptables du cas du Domaine de la Preuve, l'audit de prospection et le ciblage des 126k prospects) constituent un travail d'audit personnel, factuel et sourcé conjointement avec la Direction Data.</li>
            </ul>
        </div>
        
        <p style="text-align: center; margin-top: 25px; color: var(--gold); font-style: italic; font-size: 10.5pt; line-height: 1.5;">
...
# PAGE 33b (Nouvelle page pour Chapitre 10 - Partie 2)
pages.append({
    "section": "CHAPITRE 10 : EXEMPLES PROMPTS",
    "content": """
...
pages.append({
    ...
    "content": """
        ...
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 1 : L'Analyse Macro (PESTEL — 1/2) <a href=\"#page-{{PAGE_CHAPITRE 2 : LE MARCHÉ}}\" class=\"btn-retour-texte\">↩ Retour p. {{PAGE_CHAPITRE 2 : LE MARCHÉ}}</a></h1>
        ...
        <table class="table-compact">
            ...
            <tr>
                ...
                <td><strong>P — Politique</strong></td>
                ...
                <td>Volonté politique nationale de réguler le marché locatif saisonnier pour favoriser le logement permanent en zones tendues (fiscalité pénalisante pour le meublé touristique). <br><em style="color: var(--gold);">Impact Stratégique : Les réglementations locales encouragent les exploitants professionnels. Happy House aide à structurer l'activité pour s'intégrer positivement dans l'écosystème local.</em></td>
...
pages.append({
    ...
    "content": """
        ...
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 1 : L'Analyse Macro (PESTEL — 2/2) <a href=\"#page-{{PAGE_CHAPITRE 2 : LE MARCHÉ}}\" class=\"btn-retour-texte\">↩ Retour p. {{PAGE_CHAPITRE 2 : LE MARCHÉ}}</a></h1>
...
pages.append({
    ...
    "content": """
        ...
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 2 : Le Diagnostic Croisé (SWOT — 1/2) <a href=\"#page-{{PAGE_CHAPITRE 3 : AUDIT INTERNE}}\" class=\"btn-retour-texte\">↩ Retour p. {{PAGE_CHAPITRE 3 : AUDIT INTERNE}}</a></h1>
        ...
        <table class="table-compact">
            ...
            <tr>
                ...
                <td style='line-height: 1.4;'>
                    ...
                    <strong>1. Alliance Entegra :</strong> Contrat exclusif validé avec la centrale d'achats globale, offrant des remises immédiates de 15-25% (F&B, énergie, blanchisserie). Gains de 4 120€ mesurés (Cas du Domaine de la Preuve).<br><br>
                    ...
                    <strong>3. Image Premium :</strong> Positionnement qualitatif "Premium & Charme" validé, réseau actif de 146 membres historiques.
...
pages.append({
    ...
    "content": """
        ...
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 2 : Le Diagnostic Croisé (SWOT — 2/2) <a href=\"#page-{{PAGE_CHAPITRE 3 : AUDIT INTERNE}}\" class=\"btn-retour-texte\">↩ Retour p. {{PAGE_CHAPITRE 3 : AUDIT INTERNE}}</a></h1>
...
pages.append({
    ...
    "content": """
        ...
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 3 : Les 5 Forces de Porter (1/2) <a href=\"#src-annexe-porter\" class=\"btn-retour-texte\">↩ RETOUR TEXTE (p. {{PAGE_CHAPITRE 2 : LE MARCHÉ}})</a></h1>
        ...
        <table class="table-compact">
            ...
            <tr>
                ...
                <td>Cibler le segment Premium & Charme requiert une double expertise (hôtelière et technologique) ainsi que des bases de données volumineuses. Le ticket d'entrée intellectuel et notre réseau de 146 membres créent de fortes barrières.</td>
...
pages.append({
    ...
    "content": """
        ...
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 3 : Les 5 Forces de Porter (2/2) <a href=\"#src-annexe-porter\" class=\"btn-retour-texte\">↩ RETOUR TEXTE (p. {{PAGE_CHAPITRE 2 : LE MARCHÉ}})</a></h1>
...
pages.append({
    ...
    "content": """
        ...
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 4 : Les Limites de l'Outbound <a href=\"#page-{{PAGE_CHAPITRE 5 : AUDIT ACQUISITION}}\" class=\"btn-retour-texte\">↩ Retour p. {{PAGE_CHAPITRE 5 : AUDIT ACQUISITION}}</a></h1>
...
pages.append({
    ...
    "section": "ANNEXE 5 & 10 : CHURN & PREUVE",
    ...
    "content": """
        ...
        <h2 style='font-size: 11.5pt; color: #E74C3C; margin-bottom: 6px;'>Annexe 5 : Le Bilan de l'Attrition Outbound <a href="#src-annexe-churn" class="btn-retour-texte">↩ RETOUR TEXTE (p. {{PAGE_CHAPITRE 3 : AUDIT INTERNE}})</a></h2>
        ...
        <h2 style='font-size: 11.5pt; color: #2ECC71; margin-top: 15px; margin-bottom: 6px;'>Annexe 10 : La Validation Comptable (Cas du Domaine de la Preuve) <a href="#src-annexe-preuve" class="btn-retour-texte">↩ RETOUR TEXTE (p. {{PAGE_CHAPITRE 8 : LE PLAN D'ACTION}})</a></h2>
...
pages.append({
    ...
    "content": """
        ...
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 6 & 7 : Le Pivot du Script SDR <a href=\"#page-{{PAGE_CHAPITRE 6 : L'ANATOMIE DU PIVOT}}\" class=\"btn-retour-texte\">↩ Retour p. {{PAGE_CHAPITRE 6 : L'ANATOMIE DU PIVOT}}</a></h1>
...
pages.append({
    ...
    "content": """
        ...
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 8 : Outils Opérationnels (CRM & Emails) <a href=\"#page-{{PAGE_CHAPITRE 4 : AUDIT DATA & LOI ALUR}}\" class=\"btn-retour-texte\">↩ Retour p. {{PAGE_CHAPITRE 4 : AUDIT DATA & LOI ALUR}}</a></h1>
...
pages.append({
    ...
    "content": """
        ...
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 9 : La Pression Commerciale Externe (1/2) <a href=\"#page-{{PAGE_CHAPITRE 2 : LE MARCHÉ}}\" class=\"btn-retour-texte\">↩ Retour p. {{PAGE_CHAPITRE 2 : LE MARCHÉ}}</a></h1>
...
pages.append({
    ...
    "content": """
        ...
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 9 : Pression Commerciale Externe (2/2) <a href=\"#page-{{PAGE_CHAPITRE 2 : LE MARCHÉ}}\" class=\"btn-retour-texte\">↩ Retour p. {{PAGE_CHAPITRE 2 : LE MARCHÉ}}</a></h1>
...
pages.append({
    ...
    "content": """
        ...
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 11 : Extraits des Pièces Justificatives <a href=\"#page-{{PAGE_CHAPITRE 8 : LE PLAN D'ACTION}}\" class=\"btn-retour-texte\">↩ Retour p. {{PAGE_CHAPITRE 8 : LE PLAN D'ACTION}}</a></h1>
        ...
        <div class="glass-card" style="padding: 12px 15px; margin-bottom: 15px; font-size: 9pt;">
            ...
            <p style="color: #FFF; line-height: 1.4; margin: 0;">
                ...
                <strong>Livrable :</strong> Contrat d'adhésion liant le domaine "Domaine de la Preuve" au réseau Happy House.<br>
        ...
        <div class="glass-card" style="padding: 12px 15px; border-color: #2ECC71; font-size: 9pt;">
            ...
            <div class="visual-title" style="color: #2ECC71; font-size: 10pt; margin-bottom: 8px;">EXTRAIT 2 : RELEVÉS DE PERFORMANCE (Tableau de Bord du Domaine de la Preuve)</div>
...
pages.append({
    ...
    "content": """
        ...
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 12 : Social Selling (Réseau B2B) <a href=\"#src-annexe-links\" class=\"btn-retour-texte\">↩ RETOUR TEXTE (p. {{PAGE_CHAPITRE 9 : CV DIGITAL}})</a></h1>
...
def make_page(content, page_num, section_title, show_sommaire_footer=True):
    ...
    # Keep an empty div or layout placeholder so flex align remains correct
    ...
    sommaire_btn = '<div style="width: 80px;"></div>'
    ...
    <div class="page">
        ...
        <div class="footer">
            ...
            <div style="color: #DDA83E; font-size: 7.2pt; text-transform: uppercase;">{section_title}</div>
            ...
            <div class="page-number" style="color: #DDA83E; font-size: 7.5pt;">{page_num:02d}</div>
...
"""
        ...
        is_annexe = p["section"].startswith("ANNEXE")
        ...
        final_html += make_page(p["content"], page_number, p["section"], show_sommaire_footer=not is_annexe)
